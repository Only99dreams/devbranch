...
import { Radio, Heart, BookOpen, Gift, MessageCircle, Users, Download } from "lucide-react";
...
export function QuickActions() {
  ...
  if (isInstallable) {
    allActions.push({
      title: "Install App",
      description: "Download our app for offline access",
      icon: Download,
      href: "#",
          ...
          {allActions.map((action, index) => (
            action.onClick ? (
              <button
                ...
                className="group relative overflow-hidden rounded-2xl bg-card p-6 shadow-card hover:shadow-elevated transition-all duration-500 animate-slide-up text-left"
